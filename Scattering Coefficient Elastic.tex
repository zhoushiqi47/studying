...
A_0=\cos(\theta-\phi-t_2)=\hat d_1 \cdot \hat d_2=d_1 \cdot d_2\\ A_1=\cos(\theta-\phi+t_2)=\hat d_0 \cdot \hat d_2=d_0\cdot d_2 \\ A_2=-\sin 2(\theta-\phi)=2(\hat d_0,\hat{a}\nu)(\hat d_0,\hat\nu^\perp)=2(d_0,\nu)(d_0,\nu^\perp)
\een
...
\be\label{kir_p}\nn
\sigma(u)\cdot\nu=[\i k_p A_0 (\lambda\nu+2\mu(d_0,\nu)d_0)+\i k_p A_1 (\lambda\nu+2\mu(d_1,\nu)d_1)\\+\i k_s A_2\mu((d_2,\nu)d_2^\perp+(d_2^\perp,\nu)d_2)]e^{\i k_p x\cdot d}:=\i k_p A_0 \hat \mathbf{R}_p(x,d,\nu) e^{\i k_p x\cdot d}
\ee For S-wave
\be\label{kir_s}\nn
\sigma(u)\cdot\nu=[\i k_s A_0 \mu((d_0,\nu)d_0^\perp+(d_0^\perp,\nu)d_0)+\i k_p A_1 (\lambda\nu+2\mu(d_1,\nu)d_1)\\+\i k_s A_2\mu((d_2,\nu)d_2^\perp+(d_2^\perp,\nu)d_2)]e^{\i k_s x\cdot d}:=\i k_s A_0\hat \mathbf{R}_s(x,d,\nu) e^{\i k_s x\cdot d}
\ee
\begin{definition}
