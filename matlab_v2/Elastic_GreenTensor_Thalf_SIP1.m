function G=Elastic_GreenTensor_Thalf_SIP1(omega,kp,ks,y,x)
% 向量形式积分
%y is point source
% 2016 9 21 
% 积分路径是复平面上的
...
Gc1=integral(@(t) A1(t) ,-L+1i,L-1i,'Waypoints',[-1+1i,1-1i], 'ArrayValued',true);
Gc2=integral(@(t) A2(t) ,-L+1i,L-1i,'Waypoints',[-1+1i,1-1i], 'ArrayValued',true);
Gc3=integral(@(t) A3(t) ,-L+1i,L-1i,'Waypoints',[-1+1i,1-1i], 'ArrayValued',true);
Gc4=integral(@(t) A4(t) ,-L+1i,L-1i,'Waypoints',[-1+1i,1-1i], 'ArrayValued',true);
