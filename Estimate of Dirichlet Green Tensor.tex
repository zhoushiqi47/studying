...
\begin{lem}
	...
	\leq C(\cos\phi\frac{1}{\rho^{3/4}}+\sin\phi\frac{1}{\rho^{5/4}})
	\ee	
\end{lem}
\debproof
The proof will be split into two parts about whether $\phi$ equal to $\phi_\kappa$.
\be\hspace{-1cm}
f'(\theta)=g_1'(\theta)+(g_2'(\theta)(\kappa^2-\sin^2(\theta+\phi))-g_2(\theta))\frac{1}{(\kappa^2-\sin^2(\theta+\phi))^{1/2}}\\
:=h_1(\theta)+h_2(\theta)\frac{1}{(\kappa^2-\sin^2(\theta+\phi))^{1/2}}
\ee
\finproof
