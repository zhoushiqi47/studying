...
\begin{figure}
	...
	\caption{Example 1: From left to right: imaging results of a Neumann, a Robin bounday with impedance $\eta(x)=1$, and a penetrable obstacle with diffractive index $n(x)=0.25$}\label{figure_1}
\end{figure}
\section*{References}
\bibliography{eee}
\end{document}
